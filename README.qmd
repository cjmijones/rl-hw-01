...
The submission will be a combination of a Jupyter notebook, `HW-1.ipynb`, with a rendered output `HW-1.html` which will act as a condensed show-case for summarization of your results, and a compressed folder with a python package called `Tabula`, which you will write from scratch.
...
In the file `HW-1.ipynb`, showcase the results of your package.
